// data/mmpiData.ts (1. sorudan 300. soruya kadar olan kısım)
...
export const mmpiQuestions = [
  ...
  "16. Babam iyi bir adamdır",
  "17. Hayatta kötülükler hep beni bulur",
  ...
  "211. Gündüzleri uyuyabilirim fakat geceleri uyuyamam",
  ...
  "238. Zaman zaman yerimde duramayacak huzursuzluk duyduğum devreler olur",
  ...
  "260. Okulda iken ağır öğrenenlerden biri idim",
  ...
  "487. Sık sık dua ederim",
  "488. Uğraştığım iş yolunda gitmeyince hemen vaz geçerim",
  ...
  "548. Elimdeyse açık saçık numaraların yapılacağı eğlence yerlerine gitmem",
