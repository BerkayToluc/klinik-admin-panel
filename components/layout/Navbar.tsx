      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link
            href={`/${locale}`}
            onClick={(e) => {
              // EĞER ZATEN ANA SAYFADAYSAK VE LOGOYA BASILDIYSA:
              if (pathname === `/${locale}`) {
                e.preventDefault();
                window.scrollTo({
                  top: 0,
                ...
                // ADRES ÇUBUĞUNDAKİ # ETİKETİNİ TEMİZLE:
          ...
          <div className="hidden lg:flex items-center gap-5 xl:gap-8">
            ...
            <Link
              href={`/${locale}#about`}
              className="text-sm font-medium text-ink-light hover:text-sage-500 transition-colors whitespace-nowrap"
            >
              {t('about')}
            </Link>
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-[70px] w-56 bg-white border border-sand-500/20 shadow-xl rounded-2xl p-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  >
                    ...
                    <div className="flex flex-col text-left">
                      ...
                      <span className="text-[10px] text-ink-light leading-none mt-1 whitespace-nowrap">
                        Online Testler
                      </span>
                    </div>
                  </Link>
            ...
            <div className="flex items-center gap-4 xl:gap-6 pl-4 xl:pl-6 border-l border-sand-500/30">
              ...
              <div className="flex items-center gap-3 pr-4 border-r border-sand-500/30">
                ...
                <a
                  href="https://www.linkedin.com/in/g%C3%B6k%C3%A7e-tolu%C3%A7-sakl%C4%B1-779a88172/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-ink-light hover:text-sage-500 transition-colors"
                >
                  <LinkedinIcon className="w-4 h-4" />
                </a>

                <a
                  href="https://www.instagram.com/psikologgokcetoluc/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-ink-light hover:text-sage-500 transition-colors"
                >
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-medium text-ink-light hover:text-sage-500 transition-colors whitespace-nowrap"
              >
              ...
              <Link
                href={`/${locale}#booking`}
                className="inline-flex items-center justify-center px-5 py-2.5 rounded-full bg-sage-500 text-white text-sm font-medium hover:bg-sage-700 transition-all shadow-sm whitespace-nowrap"
              >
                {t('book')}
              </Link>
            </div>
        ...
        <div className="lg:hidden bg-white border-b border-sand-500/20 absolute w-full left-0 top-20 z-40 animate-in slide-in-from-top duration-300 shadow-xl">
          ...
          <div className="px-4 pt-2 pb-6 space-y-4 shadow-xl">
            ...
            <Link
              ...
              className="block px-3 py-2 text-base font-medium text-ink-dark border-b border-sand-100"
            >
              {t('about')}
            </Link>
            ...
            <div className="border-b border-sand-100 py-2">
              ...
              <p className="px-3 py-1 text-xs font-bold text-ink-light uppercase">
                {t('scalesAndForms')}
              </p>
              ...
              <Link
                href={`/${locale}/scales`}
                onClick={() => setIsMenuOpen(false)}
                className="block px-3 py-2 text-base font-medium text-ink-dark hover:text-sage-500 pl-6 flex items-center gap-2"
              >
            ...
            <div className="pt-4 flex items-center justify-between">
              ...
              <Link
                href={`/${locale}/#booking`}
                onClick={() => setIsMenuOpen(false)}
                className="bg-sage-500 text-white px-6 py-2 rounded-full text-sm font-medium"
              >
                {t('book')}
              </Link>
            </div>
